...
| 📦 下载链接 | 📊 文件信息 |
|:---:|:---:|
| [![下载 APK](https://img.shields.io/badge/⬇️%20立即下载-FlowAlbum%20v1.0.4-0066CC?style=for-the-badge&logo=android&logoColor=white)](app/release/FlowAlbum_v1.0.4.apk) | 适用于 Android TV / 电视盒子 |
...
<details open>
<summary><b>方法一：U盘安装（推荐）✨</b></summary>

1. 📥 下载 APK 文件到电脑
2. 💾 将 APK 文件复制到 U盘根目录
3. 🔌 将 U盘插入 Android TV 的 USB 接口
4. 📂 在电视上打开文件管理器，找到 U盘中的 APK 文件
5. ✅ 点击安装，按提示完成安装

</details>

<details>
<summary><b>方法二：ADB 安装（开发者推荐）</b></summary>

1. 在电视设置中开启"开发者选项"和"USB 调试"
2. 使用数据线或 WiFi ADB 连接电视和电脑
3. 在电脑上执行命令：
   ```bash
   adb install FlowAlbum_v1.0.4.apk
   ```

</details>

<details>
<summary><b>方法三：局域网传输</b></summary>
...
> 💡 **提示**：不同 Android 版本权限提示可能略有差异，请根据实际提示操作。

### 第三步：开始欣赏
- 照片加载完成后，会自动开始播放（如已开启自动播放）
- 使用遥控器方向键浏览照片
- 点击确认键可随时暂停/继续

## ⚙️ 设置说明

按遥控器**菜单键**或点击屏幕**设置按钮**打开设置界面。
...
### 技巧 1：选择合适的切换间隔
- **风景照片**：建议 5-10 秒，让您有足够时间欣赏细节
- **人物照片**：建议 3-5 秒，节奏更轻快
- **快速浏览**：设置 1-2 秒，快速查看大量照片
...
2. 检查是否已授予存储权限
3. 尝试重启应用
4. 如果照片在 SD 卡上，确保 SD 卡已正确挂载

### Q2：为什么有些照片显示不出来？
**可能原因**：
- 照片格式不支持（支持 JPG、PNG、WEBP 等常见格式）
- 照片文件损坏
- 照片体积过大（建议单张不超过 10MB）
...
**优化建议**：
1. 增加切换间隔时间
2. 减少照片分辨率（推荐 1920x1080）
3. 关闭其他后台应用
4. 重启电视设备

### Q4：遥控器按键没有反应？
**检查步骤**：
1. 确认设备是 Android TV 系统
2. 更换遥控器电池
3. 重新配对遥控器
4. 重启应用或设备
...
### 基本支持
- 普通 Android 平板（可使用触摸操作）
- Android 大屏设备

## 🔄 版本历史

<details open>
<summary><b>🆕 v1.0.4</b> (2026-01-04) - 最新版本</summary>
...
<details>
<summary><b>v1.0.3</b> (2025-12-26)</summary>
...
<details>
<summary><b>v1.0.1</b> (2025-12-22)</summary>
...
<details>
<summary><b>v1.0.0</b> (2025-12-19) - 首次发布</summary>
